...
This document is a blueprint for your envisioned audio project: a single-ended EL84 stereo tube amplifier delivering 5-7 watts per channel, encased in a polished walnut chassis with all controls---tubes, volume, and switches---elegantly arrayed on top. Complemented by a turntable, high-efficiency speakers, and quality cables, this system is designed for pure, warm sound within a $1,000 budget. Future Self, this is your guide to realizing a timeless piece of craftsmanship.

Concept
-------

Envision a 14"x8"x4" walnut chassis, its glossy finish reflecting soft light. Four tubes---an EZ81 rectifier, a 12AX7 preamp, and two EL84 outputs---glow warmly through the top, alongside a precision DACT attenuator, a power switch, and dual triode/ultra-linear toggles. A turntable feeds a meticulously curated signal path---gold-plated connectors, Mundorf capacitors, Vishay resistors---through Edcor transformers to highly efficient speakers. At 5-7 watts, it fills a modest room with rich, analog fidelity, embodying simplicity, elegance, and dynamic headroom.

Hierarchy of Sound Quality (Design Philosophy)
----------------------------------------------
When building a Single-Ended (SE) amplifier, the system is only as good as its weakest link. This build prioritizes budget allocation based on the following sonic impacts:
1. **Output Transformers (40% Impact):** The biggest bottleneck for bass extension and high-frequency air. Edcor GXSEs are great; CXSEs are the ultimate future upgrade.
2. **Signal Path Passives (25% Impact):** The audio signal physically passes through these. The Mundorf coupling caps and DACT attenuator are non-negotiable for transparency.
3. **Tubes (15% Impact):** The "EQ" or voice of the amp. Starting with JJ Electronics for rugged reliability, with the option to "tube roll" (especially the 12AX7) later to fine-tune the warmth.
4. **Power Supply (10% Impact):** A noisy power supply equals a noisy amp. The 10H choke and Hammond power transformer provide dead-quiet Class A operation. (The rectifier's impact on tone is minimal in an SE design.)
5. **Layout & Resistors (10% Impact):** Military-spec Vishay resistors reduce hiss, and a strict star-grounding layout eliminates 60Hz hum.
...
-   **Controls**:
    -   DACT CT2 100kΩ 24-step attenuator ($120) *Crucial for perfect L/R balance.*
    -   Toggle power switch ($5)
    -   2x DPDT triode/ultra-linear switches ($10)
-   **Signal Path**:
    -   2x gold-plated RCA jacks ($10)
    -   2x Mundorf Supreme 0.1µF 400V capacitors ($30) *The heart of the amp's transparency.*
    -   Vishay RN65 resistors: 2x 100kΩ, 2x 2kΩ, 2x 100Ω ($6) *Ultra-low noise.*
    -   4x gold-plated binding posts ($15)
-   **Transformers**:
    -   Hammond 269EX power (190-0-190V, 6.3V, $60)
    -   2x Edcor GXSE10-8-3.5K output (3.5kΩ, 8Ω, $80) *(Upgrade path: Edcor CXSE)*
-   **Support**:
...
-   **Construction**: Point-to-point wiring, meticulously star-grounded for a black noise floor.
-   **Cost**: $490
...
-   **Model**: Klipsch Reference R-50M (or similar high-efficiency option, $230)
-   **Specifications**: 5.25" woofer, 1" tweeter, 92dB sensitivity, 8Ω nominal impedance
-   **Purpose**: High-efficiency design (90dB+) is absolutely critical for a 5-7W "flea-watt" amplifier, allowing the amp to breathe and providing dynamic headroom without distortion.
-   **Cost**: $230
...
-   **Grounding**: Establish a single star-ground point on the plywood insert, connecting all grounds (RCA, DACT, tubes, capacitors). *Do not compromise here; this is what prevents 60Hz hum.*
...
-   **Setup**: Connect AT-LP60X RCA to amplifier inputs, speakers to binding posts. Play a record to experience 5-7 watts of refined audio.
-   **Modes**: Toggle triode (3-5W, warm) or ultra-linear (5-7W, punchy) for desired sound.

Notes
-----

-   **Speaker Efficiency:** With a 5-7W amplifier, high-sensitivity speakers (90dB+ at 8Ω) are mandatory. Lower sensitivity speakers will cause the amp to run at maximum capacity, resulting in flabby bass and distortion. The chosen Klipsch (or Fostex/Markaudio full-range drivers) will make 7 watts sound like 20 watts.
...
-   **Future Upgrades**: The easiest path to better sound once the amp is built is upgrading the Output Transformers (e.g., Edcor CXSE) or "tube rolling" (swapping the 12AX7 for a Tung-Sol or NOS brand to change the flavor of the EQ). 
...
-   **1.1 (May 2025)**: Added Sound Quality Hierarchy. Swapped ELAC speakers (87dB/6Ω) for high-efficiency Klipsch (92dB/8Ω) to ensure proper dynamic headroom for a flea-watt amplifier. Emphasized star-grounding and signal path priorities.
